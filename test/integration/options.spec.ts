...
//       expect(hegicPoolWBTCBalanceBefore.add(calculateTotalPremium.premium).sub(hedgeFee)).to.eq(
...
//       expect(hegicStakingUSDCBalanceBefore.add(calculateTotalPremium.settlementFee)).to.eq(
